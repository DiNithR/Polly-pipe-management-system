...
{
    public partial class EMPLOYEE__INSTALLATION : Form
    {
        public EMPLOYEE__INSTALLATION()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("INSERT INTO [INSTALLATION_EMPLOYEE] (Emp_Id,InsID) VALUES ('" + txtEmp_id.Text + "','" + txtinsID.Text + "')", con);
