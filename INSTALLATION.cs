    ...
    public partial class INSTALLATION : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("INSERT INTO [INSTALLATION] (InsID,Cus_Id,Installation_Type_ID,period) VALUES ('" + txtInsID.Text + "','" + txtCusID.Text + "','" + txtInstyp.Text + "','" + period.Text + "')", con);
